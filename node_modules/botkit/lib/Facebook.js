...
function Facebookbot(configuration) {
    ...
    facebook_botkit.setupWebserver = function(port, cb) {
        ...
        request.post('https://graph.facebook.com/me/subscribed_apps?***REMOVED***' + configuration.access_token,
            function(err, res, body) {
                if (err) {
    ...
    facebook_botkit.api = {
        'thread_settings': {
            ...
            postAPI: function(message) {
                request.post('https://graph.facebook.com/v2.6/me/thread_settings?***REMOVED***' + configuration.access_token,
                    {form: message},
                    function(err, res, body) {
                        if (err) {
            ...
            deleteAPI: function(message) {
                request.delete('https://graph.facebook.com/v2.6/me/thread_settings?***REMOVED***' + configuration.access_token,
                    {form: message},
                    function(err, res, body) {
                        if (err) {
                            facebook_botkit.log('Could not configure thread settings');
